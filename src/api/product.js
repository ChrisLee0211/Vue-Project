...
export const getProductDetail = (id) => {
  ...
  let url = 'https://unszacs.m.taobao.com/h5/mtop.taobao.detail.getdetail/6.0/?api=mtop.taobao.detail.getdetail&ttid=2017%40taobao_h5_6.6.0&data=' + data + '&appKey=12574478&dataType=jsonp&type=jsonp&v=6.0';
